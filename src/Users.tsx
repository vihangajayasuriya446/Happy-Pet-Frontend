...
const Users: React.FC = () => {
  ...
  const { data: users = [], refetch, isLoading, isError } = useQuery<User[]>({
    queryKey: ["users"],
    queryFn: () => Axios.get("http://13.60.206.42:8080/api/v1/getusers").then((res) => res.data),
  ...
  const addUserMutation = useMutation({
    mutationFn: (data: FormData) =>
      Axios.post("http://13.60.206.42:8080/api/v1/adduser", data, {
        headers: {
  ...
  const updateUserMutation = useMutation({
    mutationFn: (data: FormData) =>
      Axios.put("http://13.60.206.42:8080/api/v1/updateuser", data, {
        headers: {
          "Content-Type": "multipart/form-data",
          "Authorization": `Bearer ${token}`, // Include the token
        },
  ...
  const deleteUserMutation = useMutation({
    mutationFn: (id: number) =>
      Axios.delete(`http://13.60.206.42:8080/api/v1/deleteuser/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`, // Include the token
        },
      }),
