...
const articleHeadings = {
    ...
    'BREEDS': 'Finding Your Perfect Cat',
    'BEHAVIOR': 'Understanding Feline Behavior',
...
const articles: Article[] = [
    {
        id: '1',
        title: 'Preparing Your Home for a New Cat',
        description: 'Essential tips for making your home safe, comfortable, and cat-friendly.',
        image: '/images/cat-article1.jpeg',
        category: 'PREPARATION',
        slug: 'preparing-your-home-for-a-new-cat'
    },
    {
        id: '2',
        title: 'Choosing the Right Cat Breed',
        description: 'Learn which type of cat will be the best match for your living situation and personality.',
        image: '/images/cat-article2.jpeg',
        category: 'BREEDS',
    ...
    },
    {
        ...
        description: 'Learn to interpret what your cat is communicating through their posture, tail, ears, and vocalizations.',
        image: '/images/cat-article3.jpeg',
        category: 'BEHAVIOR',
    ...
    },
    {
        ...
        description: 'How to provide mental stimulation and physical exercise for your indoor cat.',
        image: '/images/cat-article4.jpeg',
        category: 'ENRICHMENT',
        slug: 'creating-an-enriching-environment'
    },
    {
        id: '5',
        title: 'Essential Health Care for Your New Cat',
        description: 'Learn about vaccinations, regular check-ups, and preventative care for your feline companion.',
        image: '/images/cat-article5.jpeg',
        category: 'HEALTH',
        slug: 'essential-health-care-for-your-new-cat'
    }
];
            ...
            <Box sx={{ bgcolor: 'background.paper', py: 1.5, px: 2 }}>
                <Container maxWidth="lg">
                    <Breadcrumbs separator={<NavigateNextIcon fontSize="small" />} aria-label="breadcrumb">
                        ...
                        <Typography color="text.primary">Cat Adoption Articles</Typography>
                    </Breadcrumbs>
                </Container>
            </Box>
                ...
                <Container maxWidth="lg">
                    <Fade in={animate} timeout={800}>
                        <Box>
                            ...
                            >
                                Find helpful information about adopting and caring for your new feline friend.
                                Our expert-written articles cover everything from choosing the right cat to understanding behavior and health care.
                            </Typography>
                            <style>{`
                                @keyframes fadeInUp {
...
export default CatAdoptionArticles;
